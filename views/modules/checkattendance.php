...
<div class="page-content p-0 m-0" >
  ...
  <form role="form" method="POST" id="attendance">
    ...
    <input type="hidden" name="eventname" id="eventname " value="Sunday Fellowship">
    <input type="hidden" name="venue" id="venue" value="CLGF-Henares">
    <input type="hidden" name="location" id="location" value="Negros Occidental, Bacolod">
