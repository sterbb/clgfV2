...
class  ModelAttendance{
    ...
    static public function mdlAddAttendance($data){
        ...
        try{
			...
			// attendance 
			$stmt = $pdo->prepare("INSERT INTO attendance(attendanceid, stime, stype, sdate, attendancelist, eventName, venue, eventLocation) VALUES (:attendanceid, :stime, :stype, :sdate, :attendancelist, :eventName, :venue, :eventLocation)");	
			...
			$stmt->bindParam(":eventLocation", $data["location"], PDO::PARAM_STR);	
